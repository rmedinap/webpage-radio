  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved categoria as @categoria" do
        ...
        post :create, {:categoria => { "nombre" => "invalid value" }}, valid_session
        assigns(:categoria).should be_a_new(Categoria)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested categoria" do
        ...
        Categoria.any_instance.should_receive(:update_attributes).with({ "nombre" => "MyString" })
        put :update, {:id => categoria.to_param, :categoria => { "nombre" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the categoria as @categoria" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Categoria.any_instance.stub(:save).and_return(false)
        put :update, {:id => categoria.to_param, :categoria => { "nombre" => "invalid value" }}, valid_session
        assigns(:categoria).should eq(categoria)
      end
