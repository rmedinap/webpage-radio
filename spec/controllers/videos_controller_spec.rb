  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved video as @video" do
        ...
        post :create, {:video => { "link" => "invalid value" }}, valid_session
        assigns(:video).should be_a_new(Video)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested video" do
        ...
        Video.any_instance.should_receive(:update_attributes).with({ "link" => "MyString" })
        put :update, {:id => video.to_param, :video => { "link" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the video as @video" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Video.any_instance.stub(:save).and_return(false)
        put :update, {:id => video.to_param, :video => { "link" => "invalid value" }}, valid_session
        assigns(:video).should eq(video)
      end
